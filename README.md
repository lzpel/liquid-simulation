...
$$ \boldsymbol{u}^\ast &= \boldsymbol{u}^k+\delta\boldsymbol{u}^p & &; & \boldsymbol{u}^{k+1} &= \boldsymbol{u}^\ast+\delta\boldsymbol{u}^c$$
$$ \boldsymbol{r}^\ast &= \boldsymbol{r}^k+\boldsymbol{u}^k\Delta t+\delta\boldsymbol{u}^p\Delta t & &; & \boldsymbol{r}^{k+1} &= \boldsymbol{r}^\ast+\delta\boldsymbol{u}^c\Delta t$$
